...
static rt_err_t (*rt_exception_hook)(void *context) = (0);
...
void rt_hw_cpu_shutdown(void)
{
    ...
    if (!(0)) { rt_assert_handler("0", __FUNCTION__, 352); };
}
