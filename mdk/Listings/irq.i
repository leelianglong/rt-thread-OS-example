...
#line 27 "..\\rt_thread\\kernel\\irq.c"
#line 28 "..\\rt_thread\\kernel\\irq.c"
...
void rt_interrupt_enter(void)
{
    ...
    do { if (0) rt_kprintf ("irq coming..., irq nest:%d\n", rt_interrupt_nest); } while (0);
...
void rt_interrupt_leave(void)
{
    ...
    do { if (0) rt_kprintf ("irq leave, irq nest:%d\n", rt_interrupt_nest); } while (0);
