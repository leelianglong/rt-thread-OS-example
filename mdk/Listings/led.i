...
void rt_hw_led_init(void)
{
    ...
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000010)|((uint32_t)0x00000040),ENABLE);
...
void rt_hw_led_on(rt_uint32_t n)
{
    ...
    {
    case 0:
        GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), (((uint16_t)0x2000)));
        break;
    case 1:
...
void rt_hw_led_off(rt_uint32_t n)
{
    ...
    {
    case 0:
        GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), (((uint16_t)0x2000)));
        break;
    case 1:
