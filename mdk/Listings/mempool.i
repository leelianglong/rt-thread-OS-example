#line 1 "..\\rt_thread\\kernel\\mempool.c"
...
#line 34 "..\\rt_thread\\kernel\\mempool.c"
#line 35 "..\\rt_thread\\kernel\\mempool.c"
                    ...
                    rt_size_t          block_size)
{
    ...
    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 101); };
...
rt_err_t rt_mp_detach(struct rt_mempool *mp)
{
    ...
    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 152); };
...
rt_err_t rt_mp_delete(rt_mp_t mp)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 265); } } rt_hw_interrupt_enable(level); } while (0);

     
    if (!(mp != (0))) { rt_assert_handler("mp != RT_NULL", __FUNCTION__, 268); };
...
#line 301 "..\\rt_thread\\kernel\\mempool.c"
...
void *rt_mp_alloc(rt_mp_t mp, rt_int32_t time)
{
    ...
    while (mp->block_free_count == 0)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 347); } } rt_hw_interrupt_enable(level); } while (0);
    ...
    if (!(block_ptr != (0))) { rt_assert_handler("block_ptr != RT_NULL", __FUNCTION__, 392); };
