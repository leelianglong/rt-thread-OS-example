#line 1 "..\\STM32F10x_StdPeriph_Driver\\src\\misc.c"
...
#line 207 "..\\STM32F10x_StdPeriph_Driver\\inc\\misc.h"
...
#line 25 "..\\STM32F10x_StdPeriph_Driver\\src\\misc.c"
...
void NVIC_PriorityGroupConfig(uint32_t NVIC_PriorityGroup)
{
  ...
  (((((NVIC_PriorityGroup) == ((uint32_t)0x700)) || ((NVIC_PriorityGroup) == ((uint32_t)0x600)) || ((NVIC_PriorityGroup) == ((uint32_t)0x500)) || ((NVIC_PriorityGroup) == ((uint32_t)0x400)) || ((NVIC_PriorityGroup) == ((uint32_t)0x300)))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 99));
...
void NVIC_Init(NVIC_InitTypeDef* NVIC_InitStruct)
{
  ...
  (((((NVIC_InitStruct->NVIC_IRQChannelCmd) == DISABLE) || ((NVIC_InitStruct->NVIC_IRQChannelCmd) == ENABLE))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 117));
  ((((NVIC_InitStruct->NVIC_IRQChannelPreemptionPriority) < 0x10)) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 118));  
  ((((NVIC_InitStruct->NVIC_IRQChannelSubPriority) < 0x10)) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 119));
...
{ 
  ...
  (((((NVIC_VectTab) == ((uint32_t)0x20000000)) || ((NVIC_VectTab) == ((uint32_t)0x08000000)))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 159));
  ((((Offset) < 0x000FFFFF)) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 160));  
...
void NVIC_SystemLPConfig(uint8_t LowPowerMode, FunctionalState NewState)
{
  ...
  (((((LowPowerMode) == ((uint8_t)0x10)) || ((LowPowerMode) == ((uint8_t)0x04)) || ((LowPowerMode) == ((uint8_t)0x02)))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 178));
  (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 179));  
...
void SysTick_CLKSourceConfig(uint32_t SysTick_CLKSource)
{
  ...
  (((((SysTick_CLKSource) == ((uint32_t)0x00000004)) || ((SysTick_CLKSource) == ((uint32_t)0xFFFFFFFB)))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\misc.c", 202));
