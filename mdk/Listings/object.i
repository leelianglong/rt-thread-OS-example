#line 1 "..\\rt_thread\\kernel\\object.c"
...
#line 31 "..\\rt_thread\\kernel\\object.c"
...
#line 32 "..\\rt_thread\\kernel\\object.c"
...
struct rt_object_information rt_object_container[RT_Object_Class_Unknown] =
{
    ...
    {RT_Object_Class_Thread, {&(rt_object_container[RT_Object_Class_Thread]. object_list), &(rt_object_container[RT_Object_Class_Thread]. object_list)}, sizeof(struct rt_thread)},

     
    {RT_Object_Class_Semaphore, {&(rt_object_container[RT_Object_Class_Semaphore]. object_list), &(rt_object_container[RT_Object_Class_Semaphore]. object_list)}, sizeof(struct rt_semaphore)},


     
    {RT_Object_Class_Mutex, {&(rt_object_container[RT_Object_Class_Mutex]. object_list), &(rt_object_container[RT_Object_Class_Mutex]. object_list)}, sizeof(struct rt_mutex)},


     
    {RT_Object_Class_Event, {&(rt_object_container[RT_Object_Class_Event]. object_list), &(rt_object_container[RT_Object_Class_Event]. object_list)}, sizeof(struct rt_event)},


     
    {RT_Object_Class_MailBox, {&(rt_object_container[RT_Object_Class_MailBox]. object_list), &(rt_object_container[RT_Object_Class_MailBox]. object_list)}, sizeof(struct rt_mailbox)},


     
    {RT_Object_Class_MessageQueue, {&(rt_object_container[RT_Object_Class_MessageQueue]. object_list), &(rt_object_container[RT_Object_Class_MessageQueue]. object_list)}, sizeof(struct rt_messagequeue)},
#line 64 "..\\rt_thread\\kernel\\object.c"
     
    {RT_Object_Class_MemPool, {&(rt_object_container[RT_Object_Class_MemPool]. object_list), &(rt_object_container[RT_Object_Class_MemPool]. object_list)}, sizeof(struct rt_mempool)},


     
    {RT_Object_Class_Device, {&(rt_object_container[RT_Object_Class_Device]. object_list), &(rt_object_container[RT_Object_Class_Device]. object_list)}, sizeof(struct rt_device)},

     
    {RT_Object_Class_Timer, {&(rt_object_container[RT_Object_Class_Timer]. object_list), &(rt_object_container[RT_Object_Class_Timer]. object_list)}, sizeof(struct rt_timer)},
...
void rt_object_detach(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 251); };
...
rt_object_t rt_object_allocate(enum rt_object_class_type type, const char *name)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 280); } } rt_hw_interrupt_enable(level); } while (0);

#line 290 "..\\rt_thread\\kernel\\object.c"
...
#line 316 "..\\rt_thread\\kernel\\object.c"
...
void rt_object_delete(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 345); };
    if (!(!(object->type & RT_Object_Class_Static))) { rt_assert_handler("!(object->type & RT_Object_Class_Static)", __FUNCTION__, 346); };
...
rt_bool_t rt_object_is_systemobject(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 382); };
...
rt_object_t rt_object_find(const char *name, rt_uint8_t type)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 413); } } rt_hw_interrupt_enable(level); } while (0);

#line 471 "..\\rt_thread\\kernel\\object.c"

     
    rt_enter_critical();

     
    if (information == (0)) information = &rt_object_container[type];
