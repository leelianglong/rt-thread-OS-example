#line 1 "..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_dbgmcu.c"
...
#line 107 "..\\STM32F10x_StdPeriph_Driver\\inc\\stm32f10x_dbgmcu.h"
...
#line 24 "..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_dbgmcu.c"
...
void DBGMCU_Config(uint32_t DBGMCU_Periph, FunctionalState NewState)
{
  ...
  ((((((DBGMCU_Periph) & 0x800000F8) == 0x00) && ((DBGMCU_Periph) != 0x00))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_dbgmcu.c", 137));
  (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_dbgmcu.c", 138));
