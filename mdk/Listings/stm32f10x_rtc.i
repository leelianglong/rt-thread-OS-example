#line 1 "..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c"
...
#line 123 "..\\STM32F10x_StdPeriph_Driver\\inc\\stm32f10x_rtc.h"
...
#line 24 "..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c"
...
void RTC_ITConfig(uint16_t RTC_IT, FunctionalState NewState)
{
  ...
  ((((((RTC_IT) & (uint16_t)0xFFF8) == 0x00) && ((RTC_IT) != 0x00))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 93));  
  (((((NewState) == DISABLE) || ((NewState) == ENABLE))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 94));
...
void RTC_SetPrescaler(uint32_t PrescalerValue)
{
  ...
  ((((PrescalerValue) <= 0xFFFFF)) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 163));
...
FlagStatus RTC_GetFlagStatus(uint16_t RTC_FLAG)
{
  ...
  (((((RTC_FLAG) == ((uint16_t)0x0020)) || ((RTC_FLAG) == ((uint16_t)0x0008)) || ((RTC_FLAG) == ((uint16_t)0x0004)) || ((RTC_FLAG) == ((uint16_t)0x0002)) || ((RTC_FLAG) == ((uint16_t)0x0001)))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 249)); 
...
void RTC_ClearFlag(uint16_t RTC_FLAG)
{
  ...
  ((((((RTC_FLAG) & (uint16_t)0xFFF0) == 0x00) && ((RTC_FLAG) != 0x00))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 276)); 
...
ITStatus RTC_GetITStatus(uint16_t RTC_IT)
{
  ...
  (((((RTC_IT) == ((uint16_t)0x0004)) || ((RTC_IT) == ((uint16_t)0x0002)) || ((RTC_IT) == ((uint16_t)0x0001)))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 295)); 
...
void RTC_ClearITPendingBit(uint16_t RTC_IT)
{
  ...
  ((((((RTC_IT) & (uint16_t)0xFFF8) == 0x00) && ((RTC_IT) != 0x00))) ? (void)0 : assert_failed((uint8_t *)"..\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_rtc.c", 321));  
