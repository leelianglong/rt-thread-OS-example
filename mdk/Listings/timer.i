#line 1 "..\\rt_thread\\kernel\\timer.c"
...
#line 36 "..\\rt_thread\\kernel\\timer.c"
...
#line 37 "..\\rt_thread\\kernel\\timer.c"

 
static rt_list_t rt_timer_list[1];

#line 56 "..\\rt_thread\\kernel\\timer.c"
...
#line 162 "..\\rt_thread\\kernel\\timer.c"
                   ...
                   rt_uint8_t  flag)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 188); };
...
rt_err_t rt_timer_detach(rt_timer_t timer)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 209); };
...
rt_err_t rt_timer_delete(rt_timer_t timer)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 270); };
...
rt_err_t rt_timer_start(rt_timer_t timer)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 304); };
    ...
    if (!(timer->init_tick < 0xffffffff / 2)) { rt_assert_handler("timer->init_tick < RT_TICK_MAX / 2", __FUNCTION__, 320); };
    timer->timeout_tick = rt_tick_get() + timer->init_tick;

     
    level = rt_hw_interrupt_disable();

#line 334 "..\\rt_thread\\kernel\\timer.c"
    {
...
#line 407 "..\\rt_thread\\kernel\\timer.c"
...
rt_err_t rt_timer_stop(rt_timer_t timer)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 424); };
...
rt_err_t rt_timer_control(rt_timer_t timer, rt_uint8_t cmd, void *arg)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 457); };
...
void rt_timer_check(void)
{
    ...
    do { if (0) rt_kprintf ("timer check enter\n"); } while (0);
    ...
    while (!rt_list_isempty(&rt_timer_list[1-1]))
    {
        ...
        {
            do { if ((rt_timer_timeout_hook) != (0)) rt_timer_timeout_hook (t); } while (0);
            ...
            do { if (0) rt_kprintf ("current tick: %d\n", current_tick); } while (0);
    ...
    do { if (0) rt_kprintf ("timer check leave\n"); } while (0);
}
...
#line 665 "..\\rt_thread\\kernel\\timer.c"
...
void rt_system_timer_thread_init(void)
{
#line 711 "..\\rt_thread\\kernel\\timer.c"
}
