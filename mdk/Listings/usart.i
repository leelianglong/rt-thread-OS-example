...
static rt_err_t stm32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 70); };
    if (!(cfg != (0))) { rt_assert_handler("cfg != RT_NULL", __FUNCTION__, 71); };
...
static rt_err_t stm32_control(struct rt_serial_device *serial, int cmd, void *arg)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 112); };
    uart = (struct stm32_uart *)serial->parent.user_data;
    ...
    case 0x11:
        ...
        USART_ITConfig(uart->uart_device, ((uint16_t)0x0525), DISABLE);
        break;
    ...
    case 0x10:
        ...
        USART_ITConfig(uart->uart_device, ((uint16_t)0x0525), ENABLE);
        break;
...
static int stm32_putc(struct rt_serial_device *serial, char c)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 145); };
    uart = (struct stm32_uart *)serial->parent.user_data;

    uart->uart_device->DR = c;
    while (!(uart->uart_device->SR & ((uint16_t)0x0040)));
...
static int stm32_getc(struct rt_serial_device *serial)
{
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 159); };
    uart = (struct stm32_uart *)serial->parent.user_data;

    ch = -1;
    if (uart->uart_device->SR & ((uint16_t)0x0020))
    {
...
static void dma_uart_rx_idle_isr(struct rt_serial_device *serial) {
    ...
    rt_hw_serial_isr(serial, 0x03 | (recv_len << 8));
...
static void uart_isr(struct rt_serial_device *serial) {
    ...
    if (!(uart != (0))) { rt_assert_handler("uart != RT_NULL", __FUNCTION__, 233); };

    if(USART_GetITStatus(uart->uart_device, ((uint16_t)0x0525)) != RESET)
    {
        rt_hw_serial_isr(serial, 0x01);
         
        USART_ClearITPendingBit(uart->uart_device, ((uint16_t)0x0525));
    }
    if(USART_GetITStatus(uart->uart_device, ((uint16_t)0x0424)) != RESET)
    {
        dma_uart_rx_idle_isr(serial);
    }
    if (USART_GetITStatus(uart->uart_device, ((uint16_t)0x0626)) != RESET)
    {
         
        USART_ClearITPendingBit(uart->uart_device, ((uint16_t)0x0626));
    }
    if (USART_GetFlagStatus(uart->uart_device, ((uint16_t)0x0008)) == SET)
    {
        stm32_getc(serial);
    }
}
...
struct stm32_uart uart1 =
{
    ...
    USART1_IRQn,
    {
        ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),
        ((uint32_t)0x00010000),
        DMA1_Channel5_IRQn,
        0,
    },
...
#line 337 "..\\bsp\\usart.c"

#line 374 "..\\bsp\\usart.c"

#line 411 "..\\bsp\\usart.c"
...
#line 427 "..\\bsp\\usart.c"

#line 434 "..\\bsp\\usart.c"

#line 441 "..\\bsp\\usart.c"
}
...
#line 470 "..\\bsp\\usart.c"

#line 481 "..\\bsp\\usart.c"

#line 492 "..\\bsp\\usart.c"
}
...
static void DMA_Configuration(struct rt_serial_device *serial) {
    ...
    USART_ITConfig(uart->uart_device, ((uint16_t)0x0424) , ENABLE);
    ...
    DMA_ClearFlag(uart->dma.rx_gl_flag);
    DMA_ITConfig(uart->dma.rx_ch, ((uint32_t)0x00000002), ENABLE);
    USART_DMACmd(uart->uart_device, ((uint16_t)0x0040), ENABLE);
    DMA_Cmd(uart->dma.rx_ch, ENABLE);
...
{
    struct stm32_uart* uart;
    struct serial_configure config = { 115200, 8, 0, 0, 0, 0, 64, 0 };
...
#line 583 "..\\bsp\\usart.c"

#line 599 "..\\bsp\\usart.c"

#line 615 "..\\bsp\\usart.c"
}
